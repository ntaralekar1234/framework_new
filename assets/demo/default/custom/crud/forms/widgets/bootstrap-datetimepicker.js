var BootstrapDatetimepicker= {
    init:function() {
        ...
        $("#notification_send, #m_datetimepicker_1_validate, #notification_send_validate, #m_datetimepicker_3_validate").datetimepicker( {
            todayHighlight: !0, autoclose: !0, pickerPosition: "bottom-left", format: "yyyy-mm-dd hh:ii:ss", startDate: '+0d'
        }
        ),
