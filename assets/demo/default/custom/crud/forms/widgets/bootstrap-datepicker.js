var BootstrapDatepicker=function() {
    ...
    return {
        init:function() {
            ...
            $("#winner-datepicker, #winner-datepicker_validate").datepicker( {
                rtl: mUtil.isRTL(), todayHighlight: !0, format: 'yyyy-mm-dd',autoclose: true, endDate: '+0d', orientation: "bottom left", templates: t
            }
            ),
			$("#test_datepicker").datepicker( {
                 rtl: mUtil.isRTL(), todayHighlight: !0, format: 'yyyy/mm/dd',autoclose: true,  orientation: "bottom left", templates: t
            }
            ),
            $("#m_datepicker_2, #m_datepicker_2_validate").datepicker( {
                rtl: mUtil.isRTL(), todayHighlight: !0,	format: 'yyyy/mm/dd',autoclose: true, startDate: '+0d', orientation: "bottom left", templates: t
            }
            ),
            $("#m_dobpicker_2, #m_dobpicker_2_validate").datepicker( {
                rtl: mUtil.isRTL(), todayHighlight: !0, format: 'yyyy/mm/dd',autoclose: true, endDate: '-0y', orientation: "bottom left", templates: t
            }
            ),
